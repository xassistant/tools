...
public final class ThreadPoolUtils {
    ...
    public ThreadPoolUtils(@Type final int type, final int corePoolSize) {
        ...
        // TimeUnit.MILLISECONDS, new BlockingQueue<Runnable>)
     ...
     */
    public <T> T invokeAny(final Collection<? extends Callable<T>> tasks, final long timeout, final TimeUnit unit) throws InterruptedException, ExecutionException,
            TimeoutException {
