...
public class SecretUtilTest {
	...
	public void testRsa() throws Exception {
		...
		// 加密
		String cipherText = SecretUtil.encrypt(data, publicKey, SecretUtil.KEY_ALGORITHM_RSA);
		System.out.println("【加密后】：" + cipherText);

		// 解密
		String plainText = SecretUtil.decrypt(cipherText, privateKey, SecretUtil.KEY_ALGORITHM_RSA);
	...
	public void testDes() throws Exception {
		...
		// 加密
		String cipherText = SecretUtil.encrypt(data, keyContent, SecretUtil.KEY_ALGORITHM_3DES);
		System.out.println("【加密后】：" + cipherText);

		// 解密
		String plainText = SecretUtil.decrypt(cipherText, keyContent, SecretUtil.KEY_ALGORITHM_3DES);
		System.out.println("【解密后】：" + plainText);
	...
	public void testPythonSwitchJava() {
		...
		System.out.println(String.format("data[%s] : key[%s] -> cipherText[%s]", data, key, cipherText));
