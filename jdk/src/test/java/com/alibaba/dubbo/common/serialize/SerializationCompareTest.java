...
//		System.out.println("hessian:" + Bytes.bytes2hex(os.toByteArray()) + ":" + os.size());
	...
	public void testBuilderPerm() throws Exception {
		...
		System.out.println(
				"Builder write and parse 500 times in " + (System.currentTimeMillis() - now) + "ms, size " + len);
	}
	...
	public void testJavaOutputPerm() throws Exception {
		...
		System.out
				.println("java write and parse 500 times in " + (System.currentTimeMillis() - now) + "ms, size " + len);
	}
