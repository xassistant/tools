...
public class ListDG {
	 ...
	 * 拓扑排序
	 *
	 * 返回值： true 成功排序，并输入结果 false 失败(该有向图是有环的)
	 */
	...
	public static void main(String[] args) {
		...
		Edge[] edges = new Edge[] { new Edge(vexs[0], vexs[6]), new Edge(vexs[1], vexs[0]), new Edge(vexs[1], vexs[3]),
				new Edge(vexs[2], vexs[5]), new Edge(vexs[2], vexs[6]), new Edge(vexs[3], vexs[4]),
